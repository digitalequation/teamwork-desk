...
namespace Digitalequation\TeamworkDesk\Http;
...
class TeamworkDeskAPIController
{
    ...
    public function getIndex()
    {
        ...
        $priorities = Teamwork::tickets()->priorities();
        $tickets    = !empty($customerId) ? Teamwork::tickets()->customer($customerId) : [];
    ...
    {
        return success(['ticket' => Teamwork::tickets()->ticket($id)['ticket']]);
    }
    ...
    {
        return success([
            'ticket' => Teamwork::tickets()->reply($request->all()),
        ]);
    }
